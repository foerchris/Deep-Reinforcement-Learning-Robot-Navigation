...
def create_environment():
    ...
    game.load_config("/home/chfo/Deep_reinforcement_learning_Course-master/Dueling Double DQN with PER and fixed-q targets/deadly_corridor.cfg")

    # Load the correct scenario (in our case deadly_corridor scenario)
    game.set_doom_scenario_path("/home/chfo/Deep_reinforcement_learning_Course-master/Dueling Double DQN with PER and fixed-q targets/deadly_corridor.wad")
...
def preprocess_frame(frame):
    ...
    preprocessed_frame= np.resize(normalized_frame, (100, 120))
...
with tf.Session() as sess:
    ...
    game.load_config("/home/chfo/Deep_reinforcement_learning_Course-master/Dueling Double DQN with PER and fixed-q targets/deadly_corridor_testing.cfg")
